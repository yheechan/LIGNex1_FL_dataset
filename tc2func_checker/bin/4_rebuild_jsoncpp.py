...
# NOTICE! JSONCPP HAS TO BE REBUILT
# BECAUSE WHEN BUILT WITH --SAVE-TEMPS FOR INTERMEDIATE CODE
# WHICH IS FOR LINE2FUNCTION EXTRACTION
# GCOVR DOESN'T MEASURE COVERAGE BUT FAILS IN A CRASH
...
def rebuild_jsoncpp(project_dir):
    ...
    cmd = [
        ...
        # this command is for only coverage not line2function
